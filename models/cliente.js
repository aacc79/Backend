...
var ClienteSchema = new mongoose.Schema({/* Esto es un constructor. Nos permite definir qué va a tener nuestro proveedor, así como tipar los datos */
    nombre:String,
...
ClienteSchema.plugin(unique, {message: 'El cliente con ese cif ya está registrado'});/* Mensaje relacionado con el objeto del cif de ProveedorSchema */
